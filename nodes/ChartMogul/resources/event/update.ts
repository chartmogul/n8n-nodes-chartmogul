...
export const updateDescription: INodeProperties[] = [
	...
	},
	{
		...
		displayOptions: {
			show: { resource: ['event'], operation: ['update'], updateUsing: ['eventId'] },
		},
		required: true,
	...
	// TODO: API also supports updating `retracted_event_id` (subscription_event-wrapped). Not yet
	// exposed — add to options below in a future update.
	// See https://dev.chartmogul.com/reference/subscription-events/update/
	{
		...
		options: [
			...
			},
			{
				...
				routing: {
					request: { body: { subscription_event: { customer_external_id: '={{$value}}' } } },
				},
			},
			{
