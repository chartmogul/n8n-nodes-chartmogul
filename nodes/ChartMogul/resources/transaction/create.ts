...
export const createDescription: INodeProperties[] = [
	...
	// TODO: API also supports `transaction_fees_in_cents` (int) and `transaction_fees_currency`
	// (three-letter currency code) on transactions. Not yet exposed — add to options below in a
	// future update. See https://dev.chartmogul.com/reference/transactions/add/
	{
