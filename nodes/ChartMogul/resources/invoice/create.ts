...
export const createDescription: INodeProperties[] = [
	...
	// TODO: API supports `account_code` (string, optional, max 30 alphanumeric chars) on every
	// line item type (one_time / subscription / trial). Not yet exposed here — add to each
	// `values` array below in a future update. See https://dev.chartmogul.com/reference/invoices/add/
	{
		...
		options: [
			...
			},
			{
				...
				values: [
					{ displayName: 'Amount in Cents', name: 'amount_in_cents', type: 'number', default: 0 },
					{ displayName: 'Cancelled At', name: 'cancelled_at', type: 'dateTime', default: '' },
					{ displayName: 'Description', name: 'description', type: 'string', default: '' },
					{
						displayName: 'Discount Amount in Cents',
						name: 'discount_amount_in_cents',
			...
			},
			{
				...
				values: [
					...
					{ displayName: 'Type', name: 'type', type: 'hidden', default: 'trial' },
				],
			},
		],
	},
