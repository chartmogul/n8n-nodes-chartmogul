...
export const createDescription: INodeProperties[] = [
	...
	// TODO: API also supports `account_code` (string, max 30 chars) and `balance_transfer`
	// (boolean) on all line item types. Not yet exposed — add to options below in a future
	// update. See https://dev.chartmogul.com/reference/line-items/add/
	{
