...
export const updateDescription: INodeProperties[] = [
	...
	// TODO: API also supports updating `account_code` (string, max 30 chars), `balance_transfer`
	// (boolean) and `cancelled_at` (ISO 8601 timestamp). Not yet exposed — add to options below
	// in a future update. See https://dev.chartmogul.com/reference/line-items/update/
	{
