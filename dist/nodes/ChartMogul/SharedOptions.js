...
exports.SharedOptionItems = exports.TwitterField = exports.TitleField = exports.PhoneField = exports.NotesField = exports.LinkedInField = exports.LastNameField = exports.FirstNameField = exports.EmailField = exports.CustomerUUIDField = exports.DataSourceUUIDField = exports.NameField = void 0;
...
const CustomerUUIDField = (args) => {
    var _a, _b;
    const location = typeof args === 'string' ? args : args.location;
    const displayName = typeof args === 'string' ? 'Customer UUID' : ((_a = args.displayName) !== null && _a !== void 0 ? _a : 'Customer UUID');
    const description = typeof args === 'string'
        ? 'ChartMogul UUID of the Customer'
        : ((_b = args.description) !== null && _b !== void 0 ? _b : 'ChartMogul UUID of the Customer');
...
exports.CustomerUUIDField = CustomerUUIDField;
...
exports.SharedOptionItems = {
    BillingSystemField,
    CursorField,
    CustomerUUIDField: exports.CustomerUUIDField,
