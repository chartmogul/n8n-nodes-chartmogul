...
const CustomAttributesField = {
    ...
    routing: {
        request: {
            body: {
                attributes: {
                    custom: '={{$value.custom.map(item => ({ key: item.key, value: item.value, type: item.type }))}}',
                },
            },
        },
    },
...
const OwnerField = {
    ...
    type: 'string',
    default: '',
    description: 'The email of the account owner or manager for this customer - must exist as a user in ChartMogul',
...
const PrimaryContactField = {
    ...
    options: [
        SharedOptions_1.SharedOptionItems.EmailField('customer'),
        SharedOptions_1.SharedOptionItems.FirstNameField('customer'),
        SharedOptions_1.SharedOptionItems.LastNameField('customer'),
        SharedOptions_1.SharedOptionItems.LinkedInField('customer'),
        SharedOptions_1.SharedOptionItems.NotesField('customer'),
        SharedOptions_1.SharedOptionItems.PhoneField('customer'),
        SharedOptions_1.SharedOptionItems.TitleField('customer'),
        SharedOptions_1.SharedOptionItems.TwitterField('customer'),
    ],
};
const StateField = {
    displayName: 'State',
...
exports.customerFields = [
    ...
    {
        ...SharedOptions_1.SharedOptionItems.DataSourceUUIDField({ location: 'body' }),
        required: true,
        displayOptions: {
            show: {
                resource: ['customer'],
